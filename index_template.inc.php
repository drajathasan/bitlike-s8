            ...
            <div class="h-screen left-sidebar fixed">
                <div class="flex">
                    ...
                    <div class="w-1/5 h-screen">
                        ...
                        <!-- Shorcut -->
                        <svg onclick="alert('Belum tersedia di versi ini :). Mungkin versi yang lebih baru, nanti.')" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="fixed ml-3 text-white mx-auto block mt-32 hover:bg-blue-500 rounded-full cursor-pointer" viewBox="0 0 16 16" style="margin-left: 10px !important">
                        ...
                        <!-- Out -->
                        <a title="<?=__('Logout')?>" href="logout.php">
